...
<main class="form-changegps text-center">
  <form action= "http://localhost:8080/dronet/restful-services/sampleservice/changeGps" method="GET">
    <h1 class="h2 mb-4 fw-normal">Enter Your Address</h1>
    <label for="inputPassword" class="visually-hidden">Address</label>
    <input type="text" id="address" class="form-control" placeholder="Address" name="address" required>
    <button class="w-100 btn btn-lg btn-primary button" type="submit">Submit Details</button>
	  </form>
