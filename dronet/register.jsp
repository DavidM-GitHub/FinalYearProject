...
$.post("http://localhost:8080/dronet/restful-services/sampleservice/register/json",
		{
        "customer": {
            "email": email,
            "id": 7,
...
///also tried this
        $.ajax({
            url:         'http://localhost:8080/dronet/restful-services/sampleservice/register/json',
            method:      'POST',
            dataType:    'json',
            data:       data,
